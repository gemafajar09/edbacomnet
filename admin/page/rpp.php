    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    <?php 
                        $data = $con->query("SELECT * FROM tb_rpp");
                        foreach($data as $i => $a):
                    ?>
                    <tr>
                        <td><?= $i+1 ?></td>
                        ...
                        <td><a href="../upload/rpp/<?= $a['file_pdf'] ?>" target="_blank" class="btn btn-info btn-sm"><i class="fa fa-file"></i>&nbsp;&nbsp;&nbsp;<?= $a['file_pdf'] ?></a></td>
                        <td><?= $a['kelas'] ?></td>
                        <td class="text-center">
                            ...
                            <button type="button" onclick="hapusdata('<?= $a['id_rpp'] ?>')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button>
                        </td>
                    </tr>
                    <?php endforeach ?>
                </tbody>
...
<!-- modal -->
<div id="rppadd" class="modal fade" role="dialog">
    <div class="modal-dialog modal-xl">
        ...
        <div class="modal-content">
            ...
            <form action="?page=aksi/rpp/simpan" method="post" enctype="multipart/form-data">
...
<script>
    ...
    function hapusdata(id)
    {
        Swal.fire({
            ...
            showDenyButton: true,
            confirmButtonText: '<a style="color:white" href="?page=aksi/kikd/hapus&id='+id+'">Hapus</a>',
