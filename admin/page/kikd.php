    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    <?php 
                        $data = $con->query("SELECT * FROM tb_kikd");
                        foreach($data as $i => $a):
                    ?>
                    <tr>
                        <td><?= $i+1 ?></td>
                        ...
                        <td class="text-center">
                            ...
                            <button type="button" onclick="hapusdata('<?= $a['id_kikd'] ?>')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button>
                        </td>
                    </tr>
                    <?php endforeach ?>
                </tbody>
...
<!-- modal -->
<div id="kikdadd" class="modal fade" role="dialog">
    <div class="modal-dialog modal-xl">
        ...
        <div class="modal-content">
            ...
            <form action="?page=aksi/kikd/simpan" method="post" enctype="multipart/form-data">
